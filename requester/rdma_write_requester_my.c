...
doca_error_t set_default_config_value_my(struct rdma_config *cfg)
{
	...
	// DEFAULT_REMOTE_RESOURCE_CONNECTION_DESC_PATH "/tmp/remote_resource_desc_path.txt"
...
// 调用的函数
int rdma_write(const char *data_ptr, size_t data_size,uint16_t cm_port,uint16_t tcp_port)
{
...
int thread_fun(const char* filepath, uint16_t cm_port, uint16_t tcp_port, int thread_id, size_t mem_len) {
    char *data = NULL;
    size_t size = 0;
...
void *thread_entry(void *arg) {
    ...
    int ret = thread_fun(args->filepath, args->cm_port, args->tcp_port, args->thread_id, args->mem_len);
    if (ret != 0) {
...
int my_main() {
    // 4组不同的参数
    // const char *files[4] = {
    //     "/home/wangsheng/load/models/hub/checkpoints/mobilenet_v2-7ebf99e0.pth", 
    //     "/home/wangsheng/load/models/hub/checkpoints/resnet18-f37072fd.pth", 
    //     "/home/wangsheng/load/models/hub/checkpoints/mobilenet_v2-7ebf99e0.pth", 
    //     "/home/wangsheng/load/models/hub/checkpoints/resnet18-f37072fd.pth"
    // };
	const char *files[4] = {
        "/home/wangsheng/load/models/hub/checkpoints/resnet18-f37072fd.pth", 
        "/home/wangsheng/load/models/hub/checkpoints/resnet50-11ad3fa6.pth", 
        "/home/wangsheng/load/models/hub/checkpoints/resnet18-f37072fd.pth", 
        "/home/wangsheng/load/models/hub/checkpoints/resnet50-11ad3fa6.pth"
    };
    // const char *files[4] = {
    ...
    //     "/home/wangsheng/load/models/hub/checkpoints/resnet18-f37072fd.pth", 
    //     "/home/wangsheng/load/models/hub/checkpoints/resnet50-11ad3fa6.pth", 
    //     "/home/wangsheng/load/models/hub/checkpoints/densenet121-a639ec97.pth", 
    //     "/home/wangsheng/load/models/hub/checkpoints/densenet201-c1103571.pth"
    // };
    uint16_t cm_ports[4] = {13580, 13600, 13620, 13640};
    uint16_t tcp_ports[4] = {18600, 18601, 18602, 18603};
	size_t mem_lens[4] = {100 * 1024 * 1024, 300 * 1024 * 1024, 100 * 1024 * 1024, 300 * 1024 * 1024};
    ...
    //     // 直接调用线程函数，而不是创建新线程
    //     thread_fun(args.filepath, args.cm_port, args.tcp_port, args.thread_id, args.mem_len);
        
    //     DOCA_LOG_INFO("=== 第 %d 个任务执行完成 ===", i+1);
